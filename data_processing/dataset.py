...
class MultiCsvReader:
    ...
    def __init__(self, path, csv_files, max_seq_len, fields,
        ...
        for csv_file in csv_files:
            # TODO pd.read_csv and df.combine_first(df) could be more efficient. http://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.combine_first.html
